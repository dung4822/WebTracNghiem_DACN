        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercises_OnlineRooms_OnlineRoomId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_OnlineRooms_OnlineRoomId",
                        column: x => x.OnlineRoomId,
                        principalTable: "OnlineRooms",
                        principalColumn: "OnlineRoomId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseHistories", x => x.ExerciseHistoryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExerciseAnswerId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseAnswers", x => x.ExerciseAnswerId);
                    table.ForeignKey(
                        name: "FK_ExerciseAnswers_ExerciseQuestions_ExerciseQuestionId",
            ...
            migrationBuilder.CreateTable(
                name: "ExamHistoryAnswers",
                columns: table => new
                {
                    ExamHistoryAnswerId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExamHistoryId = table.Column<int>(type: "int", nullable: false),
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamHistoryAnswers", x => x.ExamHistoryAnswerId);
                    table.ForeignKey(
                        name: "FK_ExamHistoryAnswers_ExamHistories_ExamHistoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamHistoryAnswers_ExamHistoryId",
                table: "ExamHistoryAnswers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseAnswers_ExerciseQuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercises_OnlineRoomId",
                table: "Exercises",
                column: "OnlineRoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OnlineRooms_RoomCode",
                table: "OnlineRooms",
                column: "RoomCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Posts_OnlineRoomId",
                table: "Posts",
                column: "OnlineRoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOnlineRooms_UserId_OnlineRoomId",
                table: "UserOnlineRooms",
                columns: new[] { "UserId", "OnlineRoomId" },
                unique: true);
